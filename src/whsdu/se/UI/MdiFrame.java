...
public class MdiFrame extends JFrame implements ActionListener {
	...
	//菜单
	private JMenu mnuPark = new JMenu("车辆管理");
	...
	private JMenuItem mnuNowInfo = new JMenuItem("当前在校信息");
	...
	private JMenuItem mnuManIdentity = new JMenuItem("更改密码");
	...
	public MdiFrame() {
		...
		ImageIcon img = new ImageIcon("B:/停车场1.png");  //创建一个图片路径
	...
	public void disMenu() {
		...
		mnuComZhuCe.setEnabled(false);
		mnuComIdentity.setEnabled(false);
		mnuManZhuCe.setEnabled(false);
		mnuManCharge.setEnabled(false);
		mnuNowInfo.setEnabled(false);
	}
